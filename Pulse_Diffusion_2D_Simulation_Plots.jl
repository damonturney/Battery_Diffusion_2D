...
function plot_results_time_slice(ss,sim_data,k,concentration_color_map_minimum,current_density_colormap_range)
   ...
   plot_axis_han.set_ylabel("microns", labelpad=0.3)
   ...
   plot_axis_han.annotate("working\nelectrode",                                                                   (0.50,0.93), horizontalalignment="center", xycoords="axes fraction", fontsize=9)
   plot_axis_han.annotate("voltage"                                                                           ,   (0.50,0.82), horizontalalignment="center", xycoords="axes fraction", fontsize=8)
   plot_axis_han.annotate(Printf.@sprintf("%i mV" ,      sim_data.electrode_voltage_saved[k]*1000),               (0.56,0.79), horizontalalignment="right",  xycoords="axes fraction", fontsize=8)
   plot_axis_han.annotate("space ave.",                                                                           (0.19,0.96), horizontalalignment="center", xycoords="axes fraction", fontsize=8)
   plot_axis_han.annotate(Printf.@sprintf("%4.2f mA/cm", mean(sim_data.current_density_saved[k,:])/10)*L"^2",     (0.33,0.93), horizontalalignment="right", xycoords="axes fraction", fontsize=8)
   plot_axis_han.annotate("time-space ave.",                                                                      (0.85,0.96), horizontalalignment="center", xycoords="axes fraction", fontsize=8)
   plot_axis_han.annotate(Printf.@sprintf("%4.2f mA/cm", mean(sim_data.current_density_saved[4:end,:])/10)*L"^2", (0.98,0.93), horizontalalignment="right", xycoords="axes fraction", fontsize=8)
   ...
   plot_axis_han.annotate(Printf.@sprintf("%4.2f mA/cm", sim_data.superficial_cd_saved[k]/10 )*L"^2",             (0.77,0.01), horizontalalignment="right",  xycoords="axes fraction", fontsize=8)
   plot_axis_han.annotate("t.s. ave. superficial",                                                                (0.19,0.04), horizontalalignment="center", xycoords="axes fraction", fontsize=8)
   plot_axis_han.annotate(Printf.@sprintf("%4.2f mA/cm", mean(sim_data.superficial_cd_saved[4:end])/10 )*L"^2",   (0.34,0.01), horizontalalignment="right",  xycoords="axes fraction", fontsize=8)
