...
function plot_results_time_slice(ss,sim_data,k,concentration_color_map_minimum,current_density_colormap_range)
   ...
   plot_axis_han.annotate("superficial",                                                                          (0.50,0.04), horizontalalignment="center", xycoords="axes fraction", fontsize=8)
   plot_axis_han.annotate(Printf.@sprintf("%4.1f mA/cm", sim_data.superficial_cd_saved[k] )*L"^2",                (0.64,0.01), horizontalalignment="right",  xycoords="axes fraction", fontsize=8)
