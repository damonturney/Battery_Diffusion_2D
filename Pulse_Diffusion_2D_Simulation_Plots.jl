...
function plot_results_time_slice(ss,sim_data,k,concentration_color_map_minimum,current_density_colormap_range)
   ...
   plot_axis_han.annotate(Printf.@sprintf("%4.1f mA/cm", mean(sim_data.superficial_cd_saved[4:end]) )*L"^2",          (0.35,0.01), horizontalalignment="right",  xycoords="axes fraction", fontsize=8)
