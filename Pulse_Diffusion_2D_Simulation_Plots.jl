...
function plot_results_time_slice(ss,sim_data,k,concentration_color_map_minimum,current_density_colormap_range)
   ...
   plot_axis_han.annotate("space ave.",                                                                           (0.14,0.96), horizontalalignment="center", xycoords="axes fraction", fontsize=8)
   plot_axis_han.annotate(Printf.@sprintf("%4.1f mA/cm", mean(sim_data.current_density_saved[k,:])/10)*L"^2",     (0.27,0.93), horizontalalignment="right", xycoords="axes fraction", fontsize=8)
   ...
   plot_axis_han.annotate("superficial",                                                                          (0.62,0.04), horizontalalignment="center", xycoords="axes fraction", fontsize=8)
   plot_axis_han.annotate(Printf.@sprintf("%4.1f mA/cm", sim_data.superficial_cd_saved[k]/10 )*L"^2",             (0.76,0.01), horizontalalignment="right",  xycoords="axes fraction", fontsize=8)
   plot_axis_han.annotate("ave. superficial",                                                                     (0.22,0.04), horizontalalignment="center", xycoords="axes fraction", fontsize=8)
   plot_axis_han.annotate(Printf.@sprintf("%4.1f mA/cm", mean(sim_data.superficial_cd_saved[4:end])/10 )*L"^2",   (0.33,0.01), horizontalalignment="right",  xycoords="axes fraction", fontsize=8)
