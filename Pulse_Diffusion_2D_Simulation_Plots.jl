...
function plot_results_time_slice(ss,sim_data,k,concentration_color_map_minimum,current_density_colormap_range)
   ...
   plot_axis_han.annotate("space ave.",                                                                           (0.16,0.96), horizontalalignment="center", xycoords="axes fraction", fontsize=8)
   plot_axis_han.annotate(Printf.@sprintf("%4.2f mA/cm", mean(sim_data.current_density_saved[k,:])/10)*L"^2",     (0.29,0.93), horizontalalignment="right", xycoords="axes fraction", fontsize=8)
   plot_axis_han.annotate("time-space ave.",                                                                      (0.85,0.96), horizontalalignment="center", xycoords="axes fraction", fontsize=8)
   plot_axis_han.annotate(Printf.@sprintf("%4.2f mA/cm", mean(sim_data.current_density_saved[4:end,:])/10)*L"^2", (0.97,0.93), horizontalalignment="right", xycoords="axes fraction", fontsize=8)
