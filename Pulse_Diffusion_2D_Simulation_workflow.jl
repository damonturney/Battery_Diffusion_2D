...
ss,sim_data = Diffusion_2D.run_simulation(ss , 0:Int64(5E6), 1E4,  -0.01, 20, -0.01 , 10, 1E-6);  #0:Int64(1E7), 1E5, -0.01, 20, -0.01 , 10,  1E-6); # args: system_state, iterations, saved_iteration_spacing, electrode_voltage1, electrode_voltage1_ontime, electrode_voltage2, electrode_voltage2_ontime, dt 
